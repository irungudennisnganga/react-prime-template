  ...
  system_admin: [
    {
      ...
      items: [
        ...
        { label: "Team Management", icon: "pi pi-users", path: "/team" },
      ],
    },
    {
      section: "Reports",
      items: [
        ...
        { label: "System Users", icon: "pi pi-users", path: "/system-users" },
  ...
  tenant_admin: [
    {
      ...
      items: [
        ...
        { label: "Alert View", icon: "pi pi-bell", path: "/alerts" },
        { label: "Team Management", icon: "pi pi-user-plus", path: "/team" },
      ],
    },
  ],
