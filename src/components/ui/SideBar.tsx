  ...
  system_admin: [
    {
      ...
      items: [
        ...
        { label: "Tenants", icon: "pi pi-building", path: "/tenants" },
        { label: "Users", icon: "pi pi-users", path: "/users" },
        { label: "System Logs", icon: "pi pi-server", path: "/logs" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Audit Logs", icon: "pi pi-file", path: "/audit" },
  ...
  operator: [
    {
      ...
      items: [
        { label: "Dashboard", icon: "pi pi-th-large", path: "/dashboard" },
        { label: "Tasks", icon: "pi pi-list-check", path: "/tasks" },
  ...
  member: [
    {
      ...
      items: [
        { label: "Dashboard", icon: "pi pi-th-large", path: "/dashboard" },
        { label: "Targets", icon: "pi pi-wave-pulse", path: "/targets" },
        { label: "SSL Verifier", icon: "pi pi-shield", path: "/ssl-verifier" },
        { label: "Incident Center", icon: "pi pi-exclamation-triangle", path: "/incidents" },
        { label: "Alert View", icon: "pi pi-bell", path: "/alerts" },
